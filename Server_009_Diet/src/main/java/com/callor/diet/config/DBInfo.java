...
public class DBInfo {
	...
	public static class FOOD {
		...
		public static final String fd_ones = "제공량";
	...
	public static class 섭취정보 {
		...
		public final static String fd_ones = "제공량";
		...
		public final static String mf_date = "날짜";
	...
	public static class 섭취정보계산 {
		...
		public static final String mf_ones = "제공량";
		...
		public static final String mf_calbo = "탄수화물";

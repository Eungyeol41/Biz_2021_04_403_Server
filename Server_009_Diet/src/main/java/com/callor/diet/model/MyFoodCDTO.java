 ...
 * 대부분의 역할이 유사하지만 특별히 구분을 하는 이유는 한 개의 Table에 대하여 다양한 View를 사용할 때 여러 개의 VO나 DTO를 만들면서 이름을 짓는 것이 번거로워서 구분을 한다
 * 
 * MyFoodVO : Insert, Update 용
 * MyFoodDTO : SELECT 용
 * 
 * DTO(Data Transfer Object)
 * DB로부터 SELECT 데이터를 출력하는 곳으로 옮길 때 사용할 객체
 */
@Getter
@Setter
@ToString

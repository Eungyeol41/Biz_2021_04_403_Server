...
public class StringEx_01 {
	...
	public static void main(String[] args) {
		...
		/*
		 * switch 명령은 다중 if else, else if를 대신하여 사용할 수 있는 구조적인 명령문이다 단점이 반드시 case 조건을 수행한
		 * 다음 break;를 실행하여 더 이상 불필요한 코드가 실행되는 것을 막아야 하며
		 * 
		 * 만약 변수에 저장된 값이 null이면 미리 if 명령 등을 이용하여 검사를 하던지 절대 변수에 null값이 저장되지 않도록 미리 조치를 해
		 * 주어야 한다.
		 * 
		 * java 1.5 이전에는 switch문으로 문자열을 조건 처리할 수 없었다
		 * 

...
/*
 * WebBrowser를 통해서 /hello/menu/라는 요청이 오면 처리 후 응답할 클래스
 * HttpServlet 클래스
 * 
 * 	Web에서 /hello/menu/ 라는 요청이 들어오면 컨트롤러의 코드가 반응하도록 설정
 * 
 */
@WebServlet("/menu")
public class MenuController extends HttpServlet{
	...
	// Tomcat을 호출하여 여러가지 정보를 전달해 줄 method
	// Tomcat이 전달하는 정보는 HttpServletRequest, HttpServletResponse 클래스의 객체를 통해 받을 수 있다.
	@Override
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		System.out.println("Root Paht : " + rootPath);

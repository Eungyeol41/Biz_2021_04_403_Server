...
public class TodoServiceImplV1 implements TodoService{
	 ...
	 * 
	 * 객체, Entity, Relation
	 * DataBase를 만들고 Table을 생성한 후 Insert를 수행하면 실제 상황의 데이터가 Table에 저장된다.
	 * INSERT를 수행한 후 SELECT를 수행하여 조회를 할 수 있는 데이터들
	 * 
	 * 메타데이터(Meta Data)
	 * 생성한 Database, table, sequence, view ... 가 어떤 구조로 만들어져 있는가 등의 정보
	 * EX) myDB라는 DataBase에 몇 개의 table이 있는가 등의 정보를 알고 싶으면 myDB 메타데이터를 참조하면 된다
	 */
